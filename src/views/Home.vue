...
<template>
    <div class="w-screen h-screen text-center justify-center flex flex-col items-center bg-cover grayscale bg-center sm:bg-contain" :style="{ backgroundImage: `url(${backgroundImage})` }">
            
        <div class="absolute inset-0 bg-black opacity-50 ">
        </div>
        <div class="z-10">
            <h1 class="md:text-9xl text-3xl text-white font-extrabold">ARE YOU READY?</h1>
            <button 
